...
namespace UnityGraphEngineering
{
    ...
    public enum E_UnityArtifactDiagnosticSeverity
    {
        Info,
        Warning,
        Error
    ...
    [Serializable]
    public sealed class UnityArtifactScanDiagnostic
    {
        public string Code;
    ...
    public sealed class UnityArtifactImpactItem
    {
        public UnityArtifactNode Node;
        public int Distance;
    }

    public sealed class UnityArtifactImpactResult
    {
        public UnityArtifactNode Target;
        public int MaxDepth;
        public List<UnityArtifactImpactItem> Items = new List<UnityArtifactImpactItem>();
    }
}
